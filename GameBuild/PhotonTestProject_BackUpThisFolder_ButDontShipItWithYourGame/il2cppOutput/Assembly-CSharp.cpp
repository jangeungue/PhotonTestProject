...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PlayerController_OnPlayerPropertiesUpdate_m3C1860A8AB284F4C27B81A54B6B4D5B549FB69BE (PlayerController_t7E8D7042FA2D0DFEC54A1FCDF395161D88DAAE95* __this, Player_tC864A64FC55FA6E30EFD6B6FF314C9725DDA363C* ___0_targetPlayer, Hashtable_tD626399B3ADFD501225241D7366103F35472542A* ___1_changedProps, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		G_B3_0 = ((((RuntimeObject*)(Player_tC864A64FC55FA6E30EFD6B6FF314C9725DDA363C*)L_2) == ((RuntimeObject*)(Player_tC864A64FC55FA6E30EFD6B6FF314C9725DDA363C*)L_4))? 1 : 0);
		goto IL_001f;
	}
...
IL_001f:
	...
	}
	{
		...
		NullCheck(L_6);
		RuntimeObject* L_7;
		L_7 = Hashtable_get_Item_m33995CAF3384BA31ADA32E8B6D3AA69946190CA9(L_6, _stringLiteral3EBF6968BED7E8C6731BFCDBB4CC00678368015C, NULL);
		PlayerController_EquipItem_mCF3E97943437B384D0854FCFDF7A045445E6A41E(__this, ((*(int32_t*)((int32_t*)(int32_t*)UnBox(L_7, Int32_t680FF22E76F6EFAD4375103CBBFFA0421349384C_il2cpp_TypeInfo_var)))), NULL);
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PlayerController_TakeDamage_m983B6462FF610FB4E4A5FC55B39AFE7868FD77E4 (PlayerController_t7E8D7042FA2D0DFEC54A1FCDF395161D88DAAE95* __this, float ___0_damage, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		NullCheck(L_0);
		PhotonView_RPC_mD406BD732C9B9AFD46C149F63514AB3A923EB5BB(L_0, _stringLiteral47690EB1E6DB6967883F22A71A842D641216ABF5, 0, L_2, NULL);
		return;
	}
}
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PlayerController_RPC_TakeDamage_m8A46E535DC43D425369C3821CE5D2A58F1A6AE11 (PlayerController_t7E8D7042FA2D0DFEC54A1FCDF395161D88DAAE95* __this, float ___0_damage, const RuntimeMethod* method) 
{
	bool V_0 = false;
	bool V_1 = false;
	{
...
IL_0015:
	{
		...
		Image_tBC1D03F63BF71132E9A5E472B8742F172A011E7E* L_5 = __this->___healthbarImage;
...
{
	{
		TMP_Text_tE8D677872D43AD4B2AAF0D6101692A17D0B251A9* L_0 = __this->___usernameText;
		Player_tC864A64FC55FA6E30EFD6B6FF314C9725DDA363C* L_1 = ___0_player;
		NullCheck(L_1);
		String_t* L_2;
		L_2 = Player_get_NickName_mC1B2AC59B8850ABEB4DA27199675066DC3BF0738(L_1, NULL);
		NullCheck(L_0);
		VirtualActionInvoker1< String_t* >::Invoke(66, L_0, L_2);
		return;
	}
